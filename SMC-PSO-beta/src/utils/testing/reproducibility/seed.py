#======================================================================================
#==================== src/utils/testing/reproducibility/seed.py =======================
#======================================================================================
...
machines and numbers of processors. Failing to set a consistent seed can lead
to subtle nondeterministic behaviour when code implicitly calls Python's
``random`` module or NumPy's global generator.
...
# using NumPy's Generator and records the assigned seeds.
...
def set_global_seed(seed: Optional[int]) -> None:
    ...
    recorded and shared to allow replicability.

    Examples
    --------
    >>> from utils.testing.reproducibility import set_global_seed
    >>> set_global_seed(123)
    >>> import random
    >>> import numpy as np
...
def create_rng(seed: Optional[int] = None) -> np.random.Generator:
    ...
    running concurrent simulations or optimisation algorithms.
    """
    if seed is None:
