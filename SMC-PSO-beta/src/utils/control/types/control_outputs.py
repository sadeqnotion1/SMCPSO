#======================================================================================
#====================== src/utils/control/types/control_outputs.py ====================
#======================================================================================
...
implementation has to deviate from expectations.  By
...
- F. Steimann and P. Mayer, "Patterns of interface-based programming," Journal
  of Object Technology, vol. 4, no. 5, pp. 75-94, July 2005.
  http://www.jot.fm/issues/issue_2005_07/
  The authors view interfaces as contracts between a client and a supplier,
  emphasising that clear preconditions and postconditions constrain the
  behaviour of implementations.  Encoding controller outputs as named tuples
  tightens the return contract and prevents ambiguous slicing or misuse.
"""
