...
# NOTE (M4 Slice 2 port): wrap_physics_config is imported lazily inside
# _initialize_dynamics_model so that `import src.simulation.core` succeeds
# before src/utils is fully ported. Call-time behavior is unchanged.
