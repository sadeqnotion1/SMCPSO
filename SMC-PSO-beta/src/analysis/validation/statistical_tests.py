    ...
    def _perform_normality_tests(self, data: np.ndarray) -> Dict[str, Any]:
        ...
        if "anderson" in self.config.normality_tests:
            try:
                ...
                p_value = None  # honest-degrade (M8-S3b): scipy.stats.anderson yields no p-value; prior hardcoded value was fabricated
                ...
                results['anderson_darling']['method'] = 'simplified'
            except Exception as e:
    ...
    def _adf_test(self, data: np.ndarray) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                'p_value': None,  # honest-degrade (M8-S3b): Dickey-Fuller distribution required for a valid p-value
    ...
    def _kpss_test(self, data: np.ndarray) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                'critical_value': critical_value,
                'p_value': None,  # honest-degrade (M8-S3b): KPSS distribution required for a valid p-value
