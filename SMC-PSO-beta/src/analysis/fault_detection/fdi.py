...
class FDIsystem:
    ...
    automatically adjusting to operating conditions.  CUSUM
    methods accumulate deviations from a reference and are sensitive to
    faint changes; however the choice of threshold and
    reference value is critical to avoid false alarms.
