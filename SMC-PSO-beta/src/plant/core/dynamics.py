...
This module provides backward compatibility for test and optimization modules
that expect plant dynamics components at src.plant.core.dynamics. All functionality
is re-exported/redirected from the actual modular implementation locations without
relying on the deprecated src/core/ dynamics shims.
"""
...
# Import canonical implementation from modular plant models
from ..models.simplified.dynamics import SimplifiedDIPDynamics as DIPDynamics
from ..models.simplified.physics import compute_simplified_dynamics_numba
