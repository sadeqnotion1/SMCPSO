...
class ClassicalSMC:
    ...
    chattering but enlarges steady-state error. Burton & Zinober (1986) show that
    continuous approximations preserve robustness while eliminating
    high-frequency switching. The
    ...
    **Gain positivity (F‑4.SMCDesign.2 / RC‑04)** – Sliding‑mode theory
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # the layer as the error vanishes.
        ...
        # the robust term is frozen to zero.  This
        ...
        # gain here to catch misconfiguration early.
        ...
        if controllability_threshold is None:
            ...
            # sliding.  A threshold proportional to
    ...
    def compute_control(
        ...
        # towards zero near the sliding manifold.
        ...
        # control inside the hysteresis band.
