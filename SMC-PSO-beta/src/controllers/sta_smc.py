...
def _sta_smc_control_numba(
    ...
    sliding mode with continuous control. Moreno & Osorio (2008) provided the first Lyapunov
    -based proof of finite-time convergence. Seeber & Horn (2017) refined parameter conditions for lower gains
...
def _sta_smc_core(
    ...
    control multiplied by ``Kaw``.  Returns
...
class SuperTwistingSMC:
    ...
    **Gain positivity (F‑4.SMCDesign.2 / RC‑04)**:  For finite‑time convergence of
    ...
    ensure robust finite‑time stability and positive
    sliding‑surface coefficients guarantee that the error terms combine with
    positive weights.  The constructor therefore
    ...
    def __init__(
        ...
        # stability and well‑posed Lyapunov surfaces.
