...
them, satisfying reproducibility guidelines [Sandve2013].
...
seed so that results can be replicated exactly [Sandve2013].
...
def configure_provenance_logging(config: Dict[str, Any], seed: int, *, level: int = logging.INFO) -> None:
    ...
    seed : int
        ...
        stochastic runs can be reproduced exactly [Sandve2013].
    level : int, optional
