...
| M5 Controller implementations | classical / sta / adaptive / hybrid + factory | [IN PROGRESS] — S1 (classical) + S2 (super-twisting) + S3 (adaptive) on main @ 00eb5696; S4-S5 pending |
